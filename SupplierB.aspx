<%@ Page Title="" Language="C#" MasterPageFile="~/TechFix.Master" AutoEventWireup="true" CodeBehind="SupplierB.aspx.cs" Inherits="TechFix.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel2" runat="server" Height="1062px" BackColor="#CCCCCC" Font-Bold="True" ForeColor="#9900CC" HorizontalAlign="Center">
    <br />
    <br />
    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="50px" Text="Supplier B's Dashboard"></asp:Label>
    <br />
    <br />
